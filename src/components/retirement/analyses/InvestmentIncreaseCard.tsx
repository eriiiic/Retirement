...
export const InvestmentIncreaseCard: React.FC<InvestmentIncreaseCardProps> = ({
  ...
  const effectiveYearsUntilRetirement = yearsUntilRetirement || 
    (retirementStartAge && currentAge ? retirementStartAge - currentAge : 30);
  ...
  // Use centralized function to calculate investment impact
  const impactDetails = useMemo(() => {
    return calculateInvestmentImpact(
      monthlyInvestment,
      investmentIncrease,
      capitalAtRetirement,
      totalNeededCapital,
  ...
  // Extract values from impact calculation
  const {
  ...
  // Calculate recommended monthly investment increase consistently for display
  const recommendedMonthlyInvestment = realistic.monthlyAmount;
  const recommendedMonthlyIncrease = recommendedMonthlyInvestment - monthlyInvestment;
          ...
          <div>
            ...
            <div className="flex items-baseline mt-1">
              <PositiveMetric className="text-base">
                {formatDisplayValue(recommendedMonthlyInvestment)}/month
              </PositiveMetric>
              <span className={cx(
                "text-xs ml-1",
            ...
            <div className={cx(
              ...
              <span>+{realistic.additionalYears} years of retirement coverage</span>
              <span className={cx(
                "ml-2",
                darkMode ? "text-yellow-300" : "text-yellow-800"
              )}>
                (until age {improvedExhaustionAge})
              </span>
            </div>
          </div>
        </div>
        ...
        <div className={cx(
          ...
          <div className={cx(
            ...
            <div className="absolute inset-0 flex items-center">
              ...
              {Math.max(improvedExhaustionAge) < targetAge && (
                <div 
                  className={cx(
                  ...
                  style={{ 
                    width: `${Math.min(100, ((targetAge - Math.max(improvedExhaustionAge)) / targetAge) * 100)}%` 
                  }}
                ></div>
              )}
              ...
              <div 
                ...
                style={{ width: `${Math.min(100, (exhaustionAge / targetAge) * 100)}%` }}
              ></div>
              
              {/* Green section for recommended plan (additional years) */}
              {improvedExhaustionAge > exhaustionAge && (
                <div 
                  className={cx(
                  ...
                  style={{ 
                    left: `${Math.min(100, (exhaustionAge / targetAge) * 100)}%`,
                    width: `${Math.min(100, ((improvedExhaustionAge - exhaustionAge) / targetAge) * 100)}%` 
                  }}
                ></div>
              )}
              ...
              {Math.max(improvedExhaustionAge) < targetAge && (
                <div 
                  ...
                  style={{ 
                    left: `${Math.min(100, (Math.max(improvedExhaustionAge) / targetAge) * 100)}%`,
                    width: `${Math.min(100, ((targetAge - Math.max(improvedExhaustionAge)) / targetAge) * 100)}%` 
                  }}
                ></div>
              )}
                ...
                {risk === 'High' ? (
                  <>
                    <span className={cx(
                      ...
                      Critical: Capital will deplete {Math.max(0, targetAge - improvedExhaustionAge)} years before target age
                    </span>
                    <div className={cx(
                      ...
                      <ul className={cx(
                        ...
                        )}>{formatDisplayValue(recommendedMonthlyInvestment)}</span> (+{Math.round(realistic.additionalCapital / 1000)}k at retirement)</li>
                        <li><span className="font-medium">Impact:</span> +{Math.round(realistic.additionalYears)} years of retirement funding</li>
                    ...
                    <div className={cx(
                      ...
                      <ul className={cx(
                        ...
                        <li><span className="font-medium">Best option:</span> Increase to <span className={cx(
                          "font-semibold",
                          darkMode ? "text-green-400" : "text-green-600"
                        )}>{formatDisplayValue(recommendedMonthlyInvestment)}</span>/month</li>
                  ...
                  <>
                    ...
                    <div className={cx(
                      ...
                      <ul className={cx(
                        ...
                        <li><span className="font-medium">Impact:</span> +{Math.round(realistic.additionalYears)} years of coverage</li>
            ...
            <div className={cx(
              ...
              <div className={cx(
                ...
                <div className={cx(
                  ...
                  +{formatDisplayValue(recommendedMonthlyIncrease)}
                </div>
                ...
                <div className={cx(
                  ...
                  +{Math.round(realistic.additionalYears)} years
                </div>
              </div>
            </div>
          </div>
