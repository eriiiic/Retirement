        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-5">
          {retirementAge && (
            <div className="bg-white rounded-xl p-3 border border-gray-100 shadow-sm">
              <div className="flex items-center mb-1">
                ...
                <span className="text-gray-500 text-sm font-medium">Retirement Age</span>
              </div>
              <p className="text-xl font-bold text-gray-800">{retirementAge} years</p>
            </div>
          )}
          ...
          {zeroCapitalAge && (
            <div className="bg-white rounded-xl p-3 border border-gray-100 shadow-sm">
              <div className="flex items-center mb-1">
                ...
                <span className="text-gray-500 text-sm font-medium">Capital Depletion</span>
              </div>
              <p className="text-xl font-bold text-gray-800">Age {zeroCapitalAge}</p>
            </div>
          )}
          ...
          {targetAge && (
            <div className="bg-white rounded-xl p-3 border border-gray-100 shadow-sm">
              <div className="flex items-center mb-1">
                ...
                <span className="text-gray-500 text-sm font-medium">Target Age</span>
              </div>
              <p className="text-xl font-bold text-gray-800">{targetAge} years</p>
            </div>
          )}
          ...
          <div className="bg-white rounded-xl p-3 border border-gray-100 shadow-sm flex flex-col justify-between">
            <div className="flex items-center mb-1">
              ...
              <span className="text-gray-500 text-sm font-medium">Toggle Data</span>
            </div>
